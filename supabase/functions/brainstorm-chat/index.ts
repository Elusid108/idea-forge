        ...
        function: {
          ...
          parameters: {
            ...
            properties: {
              ...
              updated_category: { type: "string", description: "The updated category for the brainstorm. Use one of: Product, Process, Fixture/Jig, Tool, Art, Hardware/Electronics, Software/App, Environment/Space, or suggest a new one." },
              next_question: { type: "string", description: "The next critical question to ask." },
            },
            required: ["updated_description", "updated_bullets", "updated_tags", "updated_category", "next_question"],
            additionalProperties: false,
          },
        },
      },
